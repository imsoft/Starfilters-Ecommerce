...
export const GET: APIRoute = async ({ site }) => {
  ...
  const staticPages = [
    ...
    { url: 'accesorios', priority: '0.85', changefreq: 'weekly' },
    { url: 'cuartos-limpios', priority: '0.8', changefreq: 'weekly' },
    { url: 'servicios', priority: '0.8', changefreq: 'weekly' },
    { url: 'soluciones', priority: '0.8', changefreq: 'weekly' },
    { url: 'casos-de-exito', priority: '0.85', changefreq: 'weekly' },
    { url: 'blog', priority: '0.7', changefreq: 'daily' },
    { url: 'contacto', priority: '0.6', changefreq: 'monthly' },
    { url: 'acerca-de', priority: '0.6', changefreq: 'monthly' },
    { url: 'preguntas-frecuentes', priority: '0.5', changefreq: 'monthly' },
    ...
    { url: 'en/accessories', priority: '0.85', changefreq: 'weekly' },
    { url: 'en/cleanrooms', priority: '0.8', changefreq: 'weekly' },
    { url: 'en/services', priority: '0.8', changefreq: 'weekly' },
    { url: 'en/solutions', priority: '0.8', changefreq: 'weekly' },
    { url: 'en/success-cases', priority: '0.85', changefreq: 'weekly' },
    ...
    { url: 'en/faq', priority: '0.5', changefreq: 'monthly' },
